...
def do_valid( net, valid_loader, criterion ):
    ...
    for input, length, truth, cache in valid_loader:
        input = input.cuda()
        truth = truth.cuda()
...
def run_train():
    ...
    fold    = 0
    out_dir = \
        '/root/share/project/kaggle/google_doodle/results/rnn2a_0'
    initial_checkpoint = \
        None

    pretrain_file = \
        None #'/root/share/project/kaggle/google_doodle/data/model/resnet34-333f7ec4.pth'
    ...
    train_loader  = DataLoader(
                        ...
                        num_workers = 2,
                        pin_memory  = True,
                        collate_fn  = null_stroke_collate)
    ...
    while  iter<num_iters:
        ...
        optimizer.zero_grad()
        for input, length, truth, cache in train_loader:
