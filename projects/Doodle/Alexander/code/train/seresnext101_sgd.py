...
import os
os.environ['CUDA_VISIBLE_DEVICES'] =  '3,4,5,6,7,8' #'3,2,1,0'
import sys
sys.path.append("..")
from common import *
from data   import *
...
fold    = 0
out_dir =     '../../output'
initial_checkpoint = '/rscratch/xuanyu/KAIL/Kaggle_Doddle_Rank1/Alexander/output/checkpoint/00228000_model.pth'#None #\
...
schduler = DecayScheduler(base_lr=0.0005, decay=0.1, step=num_iters/2)
