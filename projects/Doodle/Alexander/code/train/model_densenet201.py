from net.imagenet_pretrain_model.densenet import *
from utils import *
...
class Net(nn.Module):
    ...
    def __init__(self, num_class=340, is_cosine_linear = False):
        ...
        self.encoder  = densenet201(num_classes=1000, pretrained='imagenet')

        self.features = self.encoder.features

        self.fc1 = nn.Sequential(nn.Linear(1920, 512),
