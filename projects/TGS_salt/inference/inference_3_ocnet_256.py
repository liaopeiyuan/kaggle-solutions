...
RANGE=[]
for i in range(6,10):
    test_path = os.path.join('/home/liaop20/data/salt/checkpoints/ocnet_256/fold'+str(i)+'/checkpoint/'+'fold'+str(i)+'_stage2')
    print(test_path)
...
# for fold in FOLDS:
  ...
  initial_checkpoint = '/home/liaop20/data/salt/checkpoints/ocnet_256/fold'+fold+'/checkpoint/'+'fold'+fold+'_stage2/'+step+'.pth'
  model.load_state_dict(torch.load(initial_checkpoint, map_location=lambda storage, loc: storage))
  model.set_mode('test')
  model.eval()
  all_predictions = []
