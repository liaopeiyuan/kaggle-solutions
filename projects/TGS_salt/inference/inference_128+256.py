...
RANGE1=[]
RANGE1.append(np.arange(int(9.5*1000),30*1000,10*1000))
 ...
 for fold in FOLDS:
  ...
  if EVAL_256:
   ...
   if all_predictions_stacked == []:
     ...
     pickle.dump( images, open( fold+'_ResNet34_res_256'+str(step).zfill(8)+'_model.p',"wb"))
   ...
   if all_predictions_stacked == []:
     images=pickle.load( open( fold+'_ResNet34_res_256'+str(step).zfill(8)+'_model.p',"rb"))
     all_predictions_stacked=images
     preds_gmean = images
   else:
     images=pickle.load( open( fold+'_ResNet34_res_256'+str(step).zfill(8)+'_model.p',"rb"))
...
if EVAL:
 ...
 pickle.dump(  preds_gmean[0:3000,:,:], open( "256_preds_gmean_sigmoids1.p", "wb" ) )
 pickle.dump(  preds_gmean[3000:6000,:,:], open( "256_preds_gmean_sigmoids2.p", "wb" ) )
 pickle.dump(  preds_gmean[6000:9000,:,:], open( "256_preds_gmean_sigmoids3.p", "wb" ) )
 pickle.dump(  preds_gmean[9000:12000,:,:], open( "256_preds_gmean_sigmoids4.p", "wb" ) )
 pickle.dump(  preds_gmean[12000:15000,:,:], open( "256_preds_gmean_sigmoids5.p", "wb" ) )
 pickle.dump(  preds_gmean[15000:18000,:,:], open( "256_preds_gmean_sigmoids6.p", "wb" ) )
 ...
 for fold in FOLDS:
  ...
  if EVAL_128:
   ...
   if all_predictions_stacked == []:
     all_predictions_stacked=np.vstack(all_predictions)[:, 0, :, :]
     preds_gmean = np.vstack(all_predictions)[:, 0, :, :]
     pickle.dump( all_predictions_stacked, open( fold+'_ResNet34_res_'+str(step).zfill(8)+'_model.p',"wb"))
   else:
     temp=np.vstack(all_predictions)[:, 0, :, :]
     all_predictions_stacked= all_predictions_stacked+temp
     preds_gmean = preds_gmean*temp
     pickle.dump( temp, open( fold+'_ResNet34_res_256'+str(step).zfill(8)+'_model.p',"wb"))

if EVAL:
 pickle.dump( all_predictions_stacked[0:3000,:,:], open( "128_256_sigmoids1.p", "wb" ) )
 pickle.dump( all_predictions_stacked[3000:6000,:,:], open( "128_256_sigmoids2.p", "wb" ) )
 pickle.dump( all_predictions_stacked[6000:9000,:,:], open( "128_256_sigmoids3.p", "wb" ) )
 pickle.dump( all_predictions_stacked[9000:12000,:,:], open( "128_256_sigmoids4.p", "wb" ) )
 pickle.dump( all_predictions_stacked[12000:15000,:,:], open( "128_256_sigmoids5.p", "wb" ) )
 pickle.dump( all_predictions_stacked[15000:18000,:,:], open( "128_256_sigmoids6.p", "wb" ) )
 pickle.dump(  preds_gmean[0:3000,:,:], open( "128_256_preds_gmean_sigmoids1.p", "wb" ) )
 pickle.dump(  preds_gmean[3000:6000,:,:], open( "128_256_preds_gmean_sigmoids2.p", "wb" ) )
 pickle.dump(  preds_gmean[6000:9000,:,:], open( "128_256_preds_gmean_sigmoids3.p", "wb" ) )
 pickle.dump(  preds_gmean[9000:12000,:,:], open( "128_256_preds_gmean_sigmoids4.p", "wb" ) )
 pickle.dump(  preds_gmean[12000:15000,:,:], open( "128_256_preds_gmean_sigmoids5.p", "wb" ) )
 pickle.dump(  preds_gmean[15000:18000,:,:], open( "128_256_preds_gmean_sigmoids6.p", "wb" ) )
