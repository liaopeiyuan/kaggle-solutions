...
RANGE.append(np.arange(int(79.5*1000),120*1000,10*1000)) 
 ...
 for fold in FOLDS:
  ...
  if EVAL:
   ...
   if all_predictions_stacked == []:
     ...
     preds_gmean = preds_gmean*np.vstack(all_predictions)[:, 0, :, :]
 m=m+1
...
"""
pred21  = pickle.load( open( "256_preds_gmean_sigmoids1.p", "rb" ) )
pred22  = pickle.load( open( "256_preds_gmean_sigmoids2.p", "rb" ) )
pred23  = pickle.load( open( "256_preds_gmean_sigmoids3.p", "rb" ) )
pred24  = pickle.load( open( "256_preds_gmean_sigmoids4.p", "rb" ) )
pred25  = pickle.load( open( "256_preds_gmean_sigmoids5.p", "rb" ) )
pred26  = pickle.load( open( "256_preds_gmean_sigmoids6.p", "rb" ) )
