...
RANGE=[]
for i in range(0,2):
    test_path = os.path.join('/data/liao_checkpoints/ocnet_all', 'fold'+str(i))
    print(test_path)
...
for fold in FOLD:
 for step in RANGE[m]:
   ...
   initial_checkpoint = '/data/liao_checkpoints/ocnet_all/fold'+fold+'/'+step+'.pth'
   model = "OCnet_"+'fold'+fold+step
