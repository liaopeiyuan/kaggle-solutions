...
RANGE=[]
for i in range(1):
    RANGE.append(np.arange(int(9.5*1000),130*1000,10*1000))
...
for fold in FOLDS:
 for step in RANGE[0]:
   ...
   initial_checkpoint = "/data/liao_checkpoints/list_train"+fold+"_3600_ne_balanced/"+"ResNet34_res_"+ohem+str(step).zfill(8)+"_model.pth"
   model = "ResNet34_res_"+ohem+"_fold"+fold+str(step).zfill(8)
