...
RANGE=[]
for i in range(n,n+2):
    test_path = os.path.join('/data/liao_checkpoints/ocnet_256/fold'+str(n)+'/checkpoint/fold'+str(n)+'_stage2')
    print(test_path)
...
for fold in FOLD:
 for step in RANGE[m]:
   ...
   initial_checkpoint = '/data/liao_checkpoints/ocnet_256/fold'+str(n)+'/checkpoint/fold'+str(n)+'_stage2/'+step+'.pth'
