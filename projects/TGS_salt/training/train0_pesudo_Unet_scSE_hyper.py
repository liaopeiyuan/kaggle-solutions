...
FOLD = 0
ne = "_ne"
initial_checkpoint = None#"/home/liaop20/data/salt/checkpoints/list_train0_3600_ne_pseudo/ResNet34_res_256_pesudo00164500_model.pth"
MODEL = "ResNet34_"
OHEM = "res_256_pseudo"
PAD  = 0
...
def train(initial_checkpoint):
    ...
    train_dataset = TGSDataset('list_train'+str(FOLD)+'_3600'+ne+"_pseudo", train_augment, 'train')
    os.makedirs(CHECKPOINTS +'/list_train'+str(FOLD)+'_3600'+ne+"_pseudo", exist_ok=True)
